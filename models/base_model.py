...
class BaseModel():
    ...
    def to_dict(self):
        ...
        """
        created_dict = self.__dict__.copy()
        created_dict["__class__"] = self.__class__.__name__
        created_dict["created_at"] = self.created_at.isoformat()
        created_dict["updated_at"] = self.updated_at.isoformat()
